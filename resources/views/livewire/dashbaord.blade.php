<div>
    <div class="grid grid-cols-2 gap-4">
        <div class="max-w-sm rounded overflow-hidden shadow-lg m-10 bg-white">
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-2"> Proyectos</div>
                <p>{{ $totalProjects }}</p>
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg m-10 bg-white">
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-2"> Tareas</div>
                <p>{{ $totalTasks }}</p>
                    ...
                    <ul role="list" class="divide-y divide-gray-100">
                                ...
                                <a href="" class="flex justify-between gap-x-6 py-5 p-10">
                                    <div class="flex min-w-0 gap-x-4">
                                        <div class="min-w-0 flex-auto">
                                            ...
                                            <p class="text-sm font-semibold leading-6 text-gray-900">Prioridad
                                                {{ $task->priority }}</p>
                        ...
                        @empty
                            <div class="flex flex-col justify-center ">
                                <div class="text-gray-700 text-center p-10">Sin tareas agregadas
                                </div>
