    ...
    <table class="w-full  p-4 table-auto border-collapse border-2 border-gray-500 mb-4">
        <thead>
            <tr>
                ...
                <th class="border border-gray-400 px-4 py-2 text-gray-800">Codigo</th>
                <th class="border border-gray-400 px-4 py-2 text-gray-800">Tarea</th>
                <th class="border border-gray-400 px-4 py-2 text-gray-800">Prioridad</th>
                <th class="border border-gray-400 px-4 py-2 text-gray-800">Estado</th>
                <th class="border border-gray-400 px-4 py-2 text-gray-800">Fecha limite</th>
        ...
        <tbody wire:sortable="updateOrder">
            ...
            @empty
                <tr>
                    <td class="border border-gray-400 px-4 py-2 text-center" colspan="7"> Sin tareas</td>
