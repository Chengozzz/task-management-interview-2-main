               ...
               <div class="flex flex-col items-start p-4">
                   <div class="flex items-center w-full border-b pb-4">
                       <div class="text-gray-900 font-medium text-lg">
                           {{ $editMode ? 'Editar tarea' : 'Añadir tarea' }}</div>
                   ...
                   @if ($editMode)
                       <div class="w-full mt-4">
                           <x-label for='project_name'> Estado</x-label>
                           <div class="mt-2">
                   ...
                   <div class="w-full mt-4">
                       <x-label for='deadline'> Fecha limite</x-label>
                       <div class="mt-2">
               ...
               <div class="flex justify-end m-4">
                   <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded " type="submit">
                       <div role=" status" class="ml-4 mt-1" wire:loading>
                           ...
                           <span class="sr-only"> Guardando tarea...</span>
                       </div>
                       {{ $editMode ? 'Save Changes' : 'Guardar' }}
